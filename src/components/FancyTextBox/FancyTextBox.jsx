                            ...
                            <div className="fancy-text-box-bottom justify-center">
                                <div className="flex">
                                    ...
                                    {item.link && <span className="self-center text-center ml-auto">
                                        <a aria-label="link" to={item.link} className="inline-flex justify-center items-center leading-10 rounded-full bg-darkgray h-[40px] w-[40px]">
                                            <i className="feather-arrow-right text-[#fff]"></i></a>
                                    </span>}
                                </div>
                            </div>
