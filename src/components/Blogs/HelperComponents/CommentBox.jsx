                            ...
                            <ul className="blog-comment">
                                <li>
                                    <div className="flex w-full md:items-start sm:block">
                                        ...
                                        <div className="w-full pl-[25px] sm:pl-0">
                                            <a aria-label="link" to="#" className="text-darkgray font-serif font-medium text-md hover:text-fastblue">Herman Miller</a>
                                    ...
                                    <ul className="child-comment ml-[70px]">
                                        <li className="mt-[60px]">
                                            <div className="flex w-full md:items-start sm:block">
                                                ...
                                                <div className="w-full pl-[25px] sm:pl-0">
                                                    <a aria-label="link" to="#" className="text-darkgray font-serif font-medium text-md hover:text-fastblue">Wilbur Haddock</a>
                                                    <ScrollTo to="comments" offset={-100} delay={0} spy={true} smooth={true} duration={800} className="btn-reply py-[7px] px-[16px] text-spanishgray uppercase">Reply</ScrollTo>
                                        ...
                                        <li className="mt-[60px] pb-[65px]">
                                            <div className="bg-lightgray flex w-full rounded-[5px] p-[40px] md:items-start md:p-[30px] sm:p-[20px] sm:block">
                                                ...
                                                <div className="w-full pl-[25px] sm:pl-0">
                                                    <a aria-label="link" to="#" className="text-darkgray font-serif font-medium text-md hover:text-fastblue">Colene Landin</a>
                                                    <ScrollTo to="comments" offset={-100} delay={0} spy={true} smooth={true} duration={800} className="btn-reply py-[7px] px-[16px] text-spanishgray uppercase">Reply</ScrollTo>
                                ...
                                <li className="">
                                    <div className="flex w-full md:items-start  sm:block ">
                                        ...
                                        <div className="w-full pl-[25px] sm:pl-0">
                                            <a aria-label="link" to="#" className="text-darkgray font-serif font-medium text-md hover:text-fastblue">Jennifer Freeman</a>
                                            <ScrollTo to="comments" offset={-100} delay={0} spy={true} smooth={true} duration={800} className="btn-reply py-[7px] px-[16px] text-spanishgray uppercase">Reply</ScrollTo>
